...
const HeroSection = ({ serviceName, serviceDesc }: { serviceName: string, serviceDesc: string }) => {
    ...
    return (
        <div className='px-2 md:px-10 pt-0 md:pt-2 space-y-6 md:space-y-10'>
            <div className='bg-gradient-to-br from-white to-[#dfdfdf] min-h-fit rounded-3xl p-4 md:px-8 md:py-4'>
