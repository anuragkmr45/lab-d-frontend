...
const HeroSection = () => {
    ...
    return (
        <div className='px-2 md:px-10 pt-0 md:pt-2 space-y-2 md:space-y-4'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
                    <div className='col-span-3 m-auto'>
                        <h1 className='text-xl md:text-2xl font-semibold my-3'>
                            Organ Related Tests in Hyderabad at home
                        </h1>
                        ...
                        <p className='z-10 relative'>
                            Home diagnosis involves utilizing various tools and techniques to assess symptoms and health conditions within the comfort of one residence. With advancements in telemedicine and portable medical devices, individuals can now perform preliminary assessments such as temperature checks, blood pressure monitoring, and even self-administered tests for certain ailments.
                        </p>
                    ...
                    <div className='col-span-2'>
                        <Image src="/assets/organ-related/frontpage.svg" alt='csd' height={380} width={380} className='m-auto' />
                    </div>
                </div>
